...
- On `deep_sleep.enter` the hub puts the panel controller to sleep and holds the board's power
  latch pins through the sleep by itself; nothing to add to your YAML.
